import { MsgRemoveLiquidity } from '../proto/generated/tx-signer';
import { Any } from '../proto/generated/google/protobuf/any';
import { TxMsg } from "./tx-msg"

/**
 * Model representing a MsgRemoveLiquidity to send POKT from one account to another
 */
export class CustomMsgRemoveLiquidity extends TxMsg {
    public readonly fromAddress: string
    public readonly token: string
    public readonly amount: string
    public readonly KEY: string = "/x.bridgepool.MsgRemoveLiquidity"
    public readonly AMINO_KEY: string = "bridgepool/msg_remove_liquidity"
    ...
    public toStdTxMsgObj(): any {
        ...
        const result = Any.fromJSON({
            "typeUrl": this.KEY,
            "value": Buffer.from(MsgRemoveLiquidity.encode(data).finish()).toString("base64")
        });
    ...
    static decodeStdTxMsgValue(value: string): any {
        return MsgRemoveLiquidity.decode(Buffer.from(value, 'base64'))
    }
}