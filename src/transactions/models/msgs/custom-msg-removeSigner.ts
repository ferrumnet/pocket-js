import { MsgRemoveSigner } from '../proto/generated/tx-signer';
 ...
 */
export class CustomMsgRemoveSigner extends TxMsg {
    ...
    public toStdTxMsgObj(): any {
        ...
        const result = Any.fromJSON({
            "typeUrl": this.KEY,
            "value": Buffer.from(MsgRemoveSigner.encode(data).finish()).toString("base64")
        });
    ...
    static decodeStdTxMsgValue(value: string): any {
        return MsgRemoveSigner.decode(Buffer.from(value, 'base64'))
    }
}